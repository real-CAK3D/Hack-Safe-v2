  ...
  async start(constraints = {}) {
    ...
    try {
      if (!navigator.mediaDevices || !navigator.mediaDevices.getUserMedia) {
        console.warn('[Video] Browser camera unavailable here: getUserMedia needs HTTPS or localhost. Open http://127.0.0.1:8765/ruview/pose-fusion.html on the Pi for browser-webcam mode.');
        return false;
      }
